...
collaborative filtering.\todo{Inseri para colocar a parte da implementação.}
...
open-source license\todo{colocar o link para o repositório aqui}\todo{Acho 
melhor mandar para o artigo e anexar a biblioteca, para depois disponibilizar 
o código.}. The 
...
artigo, podemos colocar na documentação do código}. \todo{Eu deixaria, pois é 
apenas um apontamento com relação as operações, pois no arquivo que 
compartilhei com você eu coloco os códigos fontes com comentários.}
...
i7 model 870  \todo{confirmar modelo}
and operational 
